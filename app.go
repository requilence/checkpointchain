...
import (
	...
	"github.com/requilence/checkpointchain/x/checkpoint"
)

const appName = "checkpoint"

var (
	// default home directories for the application CLI
	DefaultCLIHome = os.ExpandEnv("$HOME/.checkpointcli")

	// DefaultNodeHome sets the folder where the applcation data and configuration will be stored
	DefaultNodeHome = os.ExpandEnv("$HOME/.checkpointd")
...
func NewNameServiceApp(logger log.Logger, db dbm.DB) *nameServiceApp {
	...
	var app = &nameServiceApp{
		...
		keyNS:            sdk.NewKVStoreKey(checkpoint.StoreKey),
	...
	app.nsKeeper = checkpoint.NewKeeper(
		app.bankKeeper,
		app.keyNS,
		app.cdc,
	)
	...
	app.mm = module.NewManager(
		...
		checkpoint.NewAppModule(app.nsKeeper, app.bankKeeper),
